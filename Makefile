...
.PHONY: image-build
IMAGE_TARGET_LIST = operator-sdk helm-operator ansible-operator ansible-operator-2.12 ansible-operator-2.11-preview scorecard-test scorecard-test-kuttl
...
IMAGE_BASE_TARGET_LIST = ansible-operator ansible-operator-2.12 ansible-operator-2.11-preview
